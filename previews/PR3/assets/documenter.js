...
requirejs.config({
  paths: {
    ...
    'highlight-bash': 'https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.0.1/languages/bash.min',
    ...
    'highlight-matlab': 'https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.0.1/languages/matlab.min',
...
////////////////////////////////////////////////////////////////////////////////
require(['jquery', 'highlight', 'highlight-julia', 'highlight-julia-repl', 'highlight-bash', 'highlight-matlab'], function($) {
$(document).ready(function() {
    hljs.highlightAll();
})
